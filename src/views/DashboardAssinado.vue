...
export default defineComponent({
  ...
  mounted() {
    ...
    if (!assinatura) {
      // Se não há pagamento confirmado, redirecionar para o dashboard público
      this.router.push('/')
      return
    }
    ...
    // Selecionar primeira aula não concluída ou a primeira aula
  ...
  methods: {
    verificarAssinatura() {
      // Se não houver mais pagamento, redirecionar imediatamente
    ...
    logout() {
      // Limpar intervalo antes de fazer logout
      if (this.intervaloVerificacao) {
        clearInterval(this.intervaloVerificacao)
        this.intervaloVerificacao = null
      }
